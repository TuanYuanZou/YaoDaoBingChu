...
- (void)_init
{
    ...
    //self.pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(self.bounds.size.width - self.bounds.size.width / 3.75 - 10, self.bounds.size.height - 10, self.bounds.size.width / 3.75, 5 )];
